...
-- IMPORTANT HINTS:
-- ! all groups planed to be used have to be listed in noe_side.lua side list
-- ! current issue, its good to have some unit growth in each of 7 levels of each unitType of buildlist making, or the factory stops production
