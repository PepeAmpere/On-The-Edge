...
local function SetResources()
	...
	for i=1,#teamList do
		...
		spSetTeamResource(id, "e", e)
		spSetTeamResource(id, "ms", ms)
		spSetTeamResource(id, "es", es)
	end
...
function gadget:Initialize()
	...
	if (numberOfNoeAITeams == 0) then
		...
		include "LuaRules/Configs/noe/noe_mex_finder.lua"
		include "LuaRules/Configs/noe/noe_build_space_finder.lua"
		include "LuaRules/Configs/noe/noe_mission_data_loader.lua"
