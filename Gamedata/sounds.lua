local Sounds = {
	SoundItems = {
		...
		orangeblob_explo = { 
			...
			rolloff=3, dopplerscale = 0, maxdist = 2500,
		...
		flamethrower = { 
            file = "sounds/notsorted/flamethrower.ogg", 
			rolloff=3, dopplerscale = 0, maxdist = 2500,
			priority = 10,
			maxconcurrent = 4,
		},
		...
		laser = { 
            file = "sounds/notsorted/laser.ogg", 
			rolloff=3, dopplerscale = 0, maxdist = 2500,
			priority = 10,
			maxconcurrent = 4,
		},
		laser1 = { 
            file = "sounds/notsorted/laser1.ogg", 
			rolloff=3, dopplerscale = 0, maxdist = 2500,
			priority = 10,
			maxconcurrent = 4,
		},
		laser2 = { 
            file = "sounds/notsorted/laser2.ogg", 
			rolloff=3, dopplerscale = 0, maxdist = 2500,
			priority = 10,
			maxconcurrent = 4,
		},
